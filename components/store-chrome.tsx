...
export function StoreHeader() {
  ...
  return <>
    ...
    <header className="site-header">
      <Link className="brand" href="/" aria-label="Infinity Sports home"><span className="brand-mark">∞</span><span>INFINITY <span>SPORTS</span></span></Link>
      ...
      <div className="header-actions">
        ...
        <Sheet>
          ...
          <SheetContent className="mobile-sheet" side="right">
            <SheetHeader><SheetTitle className="sheet-brand">INFINITY <span>SPORTS</span></SheetTitle></SheetHeader>
...
export function StoreFooter() {
  return <footer className="footer" id="contact">
    <div className="footer-top">
      <div><Link className="brand footer-brand" href="/"><span className="brand-mark">∞</span><span>INFINITY <span>SPORTS</span></span></Link><p>Original sports equipment and custom teamwear for players, clubs and academies across India.</p></div>
    ...
    <div className="footer-bottom"><span>© 2026 Infinity Sports</span><span>Made for the game.</span></div>
  </footer>;
}
